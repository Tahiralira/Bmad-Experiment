...
# The password-reset token helpers died with the template's password-auth
# stack (WS8/S5-H5): reusable 48h reset JWTs could convert a passwordless
# account into a password-authable one.
