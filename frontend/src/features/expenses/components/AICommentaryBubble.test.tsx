...
describe("AICommentaryBubble", () => {
  ...
  describe("Streamed Text", () => {
    ...
    it("shows fallback text when processing but no text yet", () => {
      render(
        <AICommentaryBubble text="" isProcessing={true} />
      )
  ...
  // Personality prop removed in WS7: tone is a server-side concern — the
  // group's ai_personality shapes the streamed text, not the bubble styling.
  // ========== Accessibility ==========
